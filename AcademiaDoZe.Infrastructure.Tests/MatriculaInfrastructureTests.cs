...
{
    private const string NomeAluno = "jonathan de souza pereira";
    private const string SiglaSgbd = "MySql";
    ...
    Arquivo? laudo = null)
    {
        ...
        id: 0, aluno: aluno, plano: plano, dataInicio: inicio, objetivo: NomeAluno, restricoesMedicas: restricoes, laudoMedico: laudo, observacoesRestricoes: obsRestricao
        );
    ...
    public async Task Matricula_Adicionar_E_ObterPorId_Sucesso()
    {
        ...
        Assert.Equal(obsRestricao, obtida.ObservacoesRestricoes);
    ...
    public async Task Matricula_Atualizar_Sucesso()
    {
        ...
        var obsRestricaoAtualizada = SiglaSgbd;
        ...
        observacoesRestricoes: obsRestricaoAtualizada
        ).Value!;
        ...
        Assert.Equal(obsRestricaoAtualizada, noBanco.ObservacoesRestricoes);
